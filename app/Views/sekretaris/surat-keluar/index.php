            ...
            <div class="col">
               <div class="card">
                  ...
                  <div class="card-body mb-4">
                     ...
                     <?php }  ?>
                     <a class=" btn btn-sm btn-success mb-3" href="<?php echo base_url('/sekretaris/surat-keluar/new') ?>"><i class="fas fa-plus"></i>Tambah Data</a>
                        ...
                        <tbody>
                           ...
                           foreach ($SuratKeluar as $key => $value) { ?>
                              <tr>
                                 ...
                                 <td>
                                    <div class="d-flex">
                                       <a class=" btn btn-sm btn-primary" href="<?php echo base_url('sekretaris/surat-keluar/' .  $value->id_sk . '/edit') ?>"><i class="fas fa-edit"></i></a>
                                       <form id="delete-form" class="form-inline ml-1" action="<?= base_url('sekretaris/surat-keluar/' .  $value->id_sk) ?>" method="POST">
