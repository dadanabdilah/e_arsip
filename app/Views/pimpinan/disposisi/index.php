                                ...
                                <tbody>
                                    ...
                                    foreach ($Disposisi as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value->status == 'menunggu_diajukan' ? '<span class="badge badge-warning">Menunggu Diajukan</span>' : ($value->status == 'diajukan' ? '<span class="badge badge-warning">Diajukan</span>' : ($value->status == 'proses' ? '<span class="badge badge-warning">Proses</span>' : '<span class="badge badge-success">Selesai</span>')) ?></td>
                                            <td>
                                                <div class="d-flex">
