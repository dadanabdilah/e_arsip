...
class SuratKeluar extends ResourceController
{
    ...
    public function index()
    {
        ...
        return view('sekretaris/surat-keluar/index', $data);
    }
    ...
    public function new()
    {
        ...
        return view('sekretaris/surat-keluar/tambah', $data);
    }
        ...
        if (!$berkas->hasMoved()) {
            ...
            if (!is_dir($filepath)) {
                if (!mkdir($filepath, 0777, TRUE)) {
                    ...
                    return redirect()->to('sekretaris/surat-keluar');
                }
            }
    ...
    public function edit($id = null)
    {
        ...
        return view('sekretaris/surat-keluar/edit', $data);
    }
